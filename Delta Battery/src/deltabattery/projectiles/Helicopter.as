package deltabattery.projectiles 
{
	 ...
	 */
	public class Helicopter extends ABST_Missile 
	{
		private var timer:Number = 0;
		
		public function Helicopter(_cg:ContainerGame, _mc:MovieClip, _origin:Point, _target:Point, _type:int=0, params:Object=null) {
			_target.y = _origin.y;
